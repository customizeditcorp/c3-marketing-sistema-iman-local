#!/usr/bin/env python3
"""
Generar foto hero de Luis asesorando a contratista
Cliente contratista de espaldas: vest guinda + longsleeve verde + gorra trucker
...
def generate_image(prompt, reference_image_path, output_path):
    ...
    payload = {
        ...
        "promptText": prompt,
        "ratio": "1344:768",  # Wide ratio for two people
        "referenceImages": [
            {
                "uri": reference_uri,
                "tag": "luis"
...
if __name__ == "__main__":
    print("=" * 60)
    print("🎬 LUIS ASESORANDO A CONTRATISTA (Cliente Informal)")
    print("=" * 60)
    
    reference_image = "/home/ubuntu/c3-marketing-sistema-iman-local/assets/team-photos/luis-arroyo-desk.png"
    output_path = "/home/ubuntu/c3-marketing-sistema-iman-local/assets/generated/00_luis_hero_with_contractor_FINAL.png"
    
    # Prompt optimizado: Cliente contratista con vestimenta informal de trabajo
    prompt = """Business consulting meeting. @luis Hispanic consultant in coral sweater with C! logo sits at white desk, warm smile, gesturing while explaining. Across from him, contractor client sits with back to camera: burgundy/maroon soft shell vest over military green long-sleeve t-shirt, trucker cap. Laptop showing analytics dashboard between them. Modern office, iMac background. Natural lighting. Professional corporate photography, Sony A7III 50mm f/1.4. Preserve exact facial features of @luis. Authentic contractor meeting atmosphere."""
